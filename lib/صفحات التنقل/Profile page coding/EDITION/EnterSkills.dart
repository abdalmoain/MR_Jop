...
class EnterSkills extends StatefulWidget {
  EnterSkills({Key? key}) : super(key: key);

  @override
  State<EnterSkills> createState() => _EnterSkillsState();
}

class _EnterSkillsState extends State<EnterSkills> {
  final _opacity = 1.0;
  final _xOffset = 0.0;
  final _yOffset = 0.0;
  // ignore: unused_field
